...
DATASET_PATH="/root/workspace/Reactive-Diffusion-Policy-on-Flexiv-rizon4s/dataset/plug_in_usb_stream_downsample1_zarr"
...
RUN_DIR="/root/workspace/Reactive-Diffusion-Policy-on-Flexiv-rizon4s/data/outputs/${OURS_TASK}/${TIMESTAMP}"
