...
def main(args=None):
    ...
    # 保留其他可选参数
    parser.add_argument('--save_file_dir', type=str, default='plug_in_charger', help='Directory to save the file')
    ...
    # 使用命令行参数构建路径
    base_dir = f'/home/wmx/Reactive-Diffusion-Policy-on-Flexiv-rizon4s/dataset_pkl/{args.save_file_dir}'
